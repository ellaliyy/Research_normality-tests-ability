...
save.image(paste0("Uniform-Onesampt-TypeI-Power",".RData"))
...
par(mfrow = c(2,1))
#Adverse effect in downstream test
plot(smpn, altmatrixc[2,,1], typ = "l", ylim = c(0.05, 1), col = 2,
     ylab = "Power",
...
par(mfrow = c(2,1))
#Adverse effect in downstream test
plot(smpn, altmatrixc[3,,1], typ = "l", ylim = c(0.05, 1), col = 2,
     ylab = "Power",
     xlab = "Sample size", main = "Adverse effect in downstream test")
for (j in 2:length(dfvec)){
